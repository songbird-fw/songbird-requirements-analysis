...
| **RUFM3.1** | U | F | M | Usability | The hierarchical tree in the interface must update dynamically, reflecting any addition or removal of VLAN sub-interfaces within 5 second of detection. | - | 
